...
- **AI Analyst:** A conversational agent providing access to news, trend analyses, briefings, and company analyses with full-text search and streaming responses. It supports saved, browsable chat sessions.
